...
public class Div extends PseudoInstruction{
	
	Operand result, op1, op2;
	
	public Div(Operand result, Operand op1, Operand op2) {
		this.result = result;
		this.op1 = op1;
		this.op2 = op2;
	}
	...
	public void writeLuaVMCode(OutputStream output, GeneratorInfo genInfo) throws IOException {
		...
		IOUtil.writeInt32(toABC(OpCode.OP_DIV, r0, r1, r2), output);
